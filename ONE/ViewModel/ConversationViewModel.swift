...
final class ConversationViewModel: ObservableObject {
    ...
    private static func makeInitialRounds() -> [ConversationRound] {
        ...
        roundOne.applyToStep(id: stepTwoId) { step in
            step.setAgentReply(agent: .gemini,  text: "Empfehlung: Features/<Name>/{Model,ViewModel,View}.")
            step.setAgentReply(agent: .claude,  text: "Gemeinsame Services/Repositories in einen Shared-Bereich legen.")
            step.setAgentReply(agent: .mistral, text: "Nicht übertreiben – klein starten, Struktur wächst mit dem Projekt.")
